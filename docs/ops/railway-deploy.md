...
Deploy the Agri-GIS PoC from the GitHub repository to Railway with a single Dockerized service.
...
3. click one field and confirm the map card appears
...
- the app reads the CSV from `/exports/agri_fields_summary.csv`
